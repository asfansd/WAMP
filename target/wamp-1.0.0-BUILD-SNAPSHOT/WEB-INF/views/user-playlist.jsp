...
<body>
	...
	<div class="playlist">
		...
		<table style="margin-left: 33%; border: 3px solid rgb(0, 94, 128)">	
			...
			<c:forEach items="${sessionScope.playlist.medialist}"  var="media">
	...
	<a class="addMedia" href="${contextPath}/media/browse.htm">No Jam?&emsp;<span class="mediaAdd">Let's Groove</span></a>
</body>
</html>